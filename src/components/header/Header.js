...
import './Header.css'
function Header({arr,setArr,size,setSize,generateRandoList,setCurrentIndex,setCurrentNext,setEndAlgo,disableEvents,setDisableEvents,speed,setSpeed,setPurple,setIsGreater}) {
    return (
        <div className="header" style={{"pointerEvents": disableEvents ? "none" : "unset", "color" : disableEvents ? "red" : "black" }}>
          <ul >
              ...
              <div className="separator"></div>
              <li  onClick={()=>{BubbleSort(arr,setArr,setCurrentIndex,setCurrentNext,setEndAlgo,setDisableEvents,speed,setPurple,setIsGreater)}} >Bubble Sort</li>
               <div className="separator"></div>
