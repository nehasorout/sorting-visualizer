...
function Bar({arr,currentIndex,currentNext,endAlgo,isGreater,red}) {     
    return (
    <div className="container" style={style1}>
             {arr.map((size,i)=>{
                 return <div className="bar" style={{
                     height: `${size}px`, width: "8%", margin: "2px", boxShadow: " 5px 5px 5px grey", color: "white", backgroundColor: `${red & currentIndex === i ? "red" : red & currentNext === i ? "red":
